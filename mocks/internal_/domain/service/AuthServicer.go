...
import (
	...
	common "github.com/amnestia/tnderlike/internal/domain/model/common"
...
func (_m *AuthServicer) Auth(_a0 context.Context, _a1 *authmodel.Account) *authmodel.LoginResponse {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *authmodel.Account) *authmodel.LoginResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *AuthServicer) Register(_a0 context.Context, _a1 *authmodel.Account) *common.DefaultResponse {
	ret := _m.Called(_a0, _a1)
	...
	if rf, ok := ret.Get(0).(func(context.Context, *authmodel.Account) *common.DefaultResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
